...
def getGenesisBlock(time=int(time.time()), 
			pszTimestamp='Shenyang will not be unsealed on April 7, 2021', 	
			...
			bits=0x1d00ffff,
			value=5000000000):
	print("start mining the genesis block...")
...
if __name__ == '__main__':
	getGenesisBlock(pszTimestamp='Neubitcoin was created on 2022-04-07.--Su Hailing',
			pubkey='045c13d245cfbe91faee1abc8edaa874cf9404eba4d280afed882d57f09c5deefdc6b49047b6e0595e7858a00b5da95a9448ea9b9784dd876dfe898c1bdca048cd',
			bits=0x207fffff,
			value=500000000)
